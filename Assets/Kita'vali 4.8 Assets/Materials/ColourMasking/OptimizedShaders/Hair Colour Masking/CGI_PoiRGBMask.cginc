    ...
    float3 calculateRGBMask(float3 baseColor)
    {
        ...
        if(float(1))
        {
            ...
            RGBColor = lerp(RGBColor, alpha.rgb * float4(1,0.6795425,0.4232678,1).rgb, rgbMask.a * alpha.a * float4(1,0.6795425,0.4232678,1).a);
            baseColor *= RGBColor;
        }
        else
        {
            ...
            baseColor = lerp(baseColor, alpha.rgb * float4(1,0.6795425,0.4232678,1).rgb, rgbMask.a * alpha.a * float4(1,0.6795425,0.4232678,1).a);
        }
        return baseColor;
    }
#endif
