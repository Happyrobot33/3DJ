    ...
    float3 calculateRGBMask(float3 baseColor)
    {
        ...
        if(float(1))
        {
            ...
            RGBColor = lerp(RGBColor, green.rgb * float4(0.301212,0.301212,0.301212,1).rgb, rgbMask.g * green.a * float4(0.301212,0.301212,0.301212,1).a);
            RGBColor = lerp(RGBColor, blue.rgb * float4(0.3185468,0.4507858,1,1).rgb, rgbMask.b * blue.a * float4(0.3185468,0.4507858,1,1).a);
            RGBColor = lerp(RGBColor, alpha.rgb * float4(1,0.6866854,0.4286905,1).rgb, rgbMask.a * alpha.a * float4(1,0.6866854,0.4286905,1).a);
            baseColor *= RGBColor;
        }
        else
        {
            baseColor = lerp(baseColor, red.rgb * float4(1,1,1,1).rgb, rgbMask.r * red.a * float4(1,1,1,1).a);
            baseColor = lerp(baseColor, green.rgb * float4(0.301212,0.301212,0.301212,1).rgb, rgbMask.g * green.a * float4(0.301212,0.301212,0.301212,1).a);
            baseColor = lerp(baseColor, blue.rgb * float4(0.3185468,0.4507858,1,1).rgb, rgbMask.b * blue.a * float4(0.3185468,0.4507858,1,1).a);
            baseColor = lerp(baseColor, alpha.rgb * float4(1,0.6866854,0.4286905,1).rgb, rgbMask.a * alpha.a * float4(1,0.6866854,0.4286905,1).a);
        }
        return baseColor;
    }
#endif
