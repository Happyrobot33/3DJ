...
float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
{
	...
	**********************************************************************/
		...
		#ifdef POI_SPECULAR
			meta.SpecularColor = poiLight.color.rgb * float4(0.03310475,0.03310475,0.03310475,1).rgb * lerp(1, albedo.rgb, _SpecularMetallic) * float4(0.03310475,0.03310475,0.03310475,1).a;
		#else
