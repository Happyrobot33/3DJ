    ...
    float3 calculateRGBMask(float3 baseColor)
    {
        ...
        {
            float3 RGBColor = 1;
            RGBColor = lerp(RGBColor, red.rgb * float4(0.03550518,0.03550518,0.03550518,1).rgb, rgbMask.r * red.a * float4(0.03550518,0.03550518,0.03550518,1).a);
            RGBColor = lerp(RGBColor, green.rgb * float4(0.2411783,0.2411783,0.2411783,1).rgb, rgbMask.g * green.a * float4(0.2411783,0.2411783,0.2411783,1).a);
            RGBColor = lerp(RGBColor, blue.rgb * float4(0.1729492,0.1729492,0.1729492,1).rgb, rgbMask.b * blue.a * float4(0.1729492,0.1729492,0.1729492,1).a);
            RGBColor = lerp(RGBColor, alpha.rgb * float4(1,1,1,1).rgb, rgbMask.a * alpha.a * float4(1,1,1,1).a);
            baseColor *= RGBColor;
        }
        else
        {
            baseColor = lerp(baseColor, red.rgb * float4(0.03550518,0.03550518,0.03550518,1).rgb, rgbMask.r * red.a * float4(0.03550518,0.03550518,0.03550518,1).a);
            baseColor = lerp(baseColor, green.rgb * float4(0.2411783,0.2411783,0.2411783,1).rgb, rgbMask.g * green.a * float4(0.2411783,0.2411783,0.2411783,1).a);
            baseColor = lerp(baseColor, blue.rgb * float4(0.1729492,0.1729492,0.1729492,1).rgb, rgbMask.b * blue.a * float4(0.1729492,0.1729492,0.1729492,1).a);
