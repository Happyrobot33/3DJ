...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/Output CRT Template", false, 85 )]
		public static void ApplyTemplateTemplatesOutputCRTTemplate()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "43d6bcb9fa7ae7448b573a3b91b57ae5" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/Templates/Recording CRT Template", false, 85 )]
		public static void ApplyTemplateTemplatesRecordingCRTTemplate()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "6f8c88c029181d44bbc1c6016d56deae" );
		}
