	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode3 = tex2D( _Metallic, uv_Metallic );
				...
				float staticSwitch4_g12 = 1.0;
			#else
				float staticSwitch4_g12 = _Udon_3DJ_PlaybackActive;
			#endif
			...
			float2 appendResult6_g14 = (float2(0.0 , ( ( _Vector1.x / _Udon_3DJ_Color_TexelSize.z ) * 0.125 )));
			float2 appendResult3_g14 = (float2(0.0 , ( ( _Vector1.y / _Udon_3DJ_Color_TexelSize.w ) * 0.125 )));
			float3 hsvTorgb28 = RGBToHSV( tex2D( _Udon_3DJ_Color, ( i.uv4_texcoord4 + appendResult38 ), appendResult6_g14, appendResult3_g14 ).rgb );
			float3 hsvTorgb29 = HSVToRGB( float3(hsvTorgb28.x,hsvTorgb28.y,(0.5 + (hsvTorgb28.z - 0.0) * (1.0 - 0.5) / (1.0 - 0.0))) );
			o.Emission = ( tex2D( _Emission, uv_Emission ) + ( tex2DNode3.g * ( ( i.uv3_texcoord3.x >= 0.0 ? tex2D( _Udon_3DJ_Color, i.uv3_texcoord3 ) : float4( 0,0,0,0 ) ) + ( i.uv4_texcoord4.x >= 0.0 ? ( staticSwitch4_g12 == 1.0 ? float4( hsvTorgb29 , 0.0 ) : float4( 0,0,0,0 ) ) : float4( 0,0,0,0 ) ) ) ) ).rgb;
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.SamplerNode;1;-266.8182,-1283.5;Inherit;True;Property;_MainTex;MainTex;8;0;Create;True;0;0;0;False;0;False;-1;None;5dfcc310f2d617b44b2fd035443e4f4c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-266.8182,-895.5;Inherit;True;Property;_Metallic;Metallic;9;0;Create;True;0;0;0;False;0;False;-1;None;ceeb347d93927e947abea9a3bb4107b3;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-266.8182,-703.5;Inherit;True;Property;_Normal;Normal;10;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;453b0e23ff55d3749ad264ec8d4507a5;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;11;-224,-400;Inherit;False;Global Textures;2;;6;5151b2ab862399e41a33b2b14a355044;0;0;5;SAMPLER2D;0;SAMPLER2D;5;SAMPLER2D;6;SAMPLER2D;7;SAMPLER2D;9
...
Node;AmplifyShaderEditor.Compare;23;1040,-320;Inherit;False;3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;2;-272,-1088;Inherit;True;Property;_Emission;Emission;11;0;Create;True;0;0;0;False;0;False;-1;None;823405bb5f3bf644eb2b853495a944aa;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;44;1296,-384;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;1472,-448;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;45;800,-96;Inherit;False;Filter Enabled;0;;12;c3596b00e3f10084ca2d087f25e7c86f;0;4;1;COLOR;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;6;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;10
...
Node;AmplifyShaderEditor.SamplerNode;27;-368,16;Inherit;True;Property;_TextureSample1;Texture Sample 0;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;8;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;25;-1951.3,-75.79999;Inherit;False;Global Textures;2;;11;5151b2ab862399e41a33b2b14a355044;0;0;5;SAMPLER2D;0;SAMPLER2D;5;SAMPLER2D;6;SAMPLER2D;7;SAMPLER2D;9
Node;AmplifyShaderEditor.FunctionNode;59;-683.5175,-116.8823;Inherit;False;Static Mip;-1;;14;68cc920048acfd54891a5b242b22bacf;0;1;10;SAMPLER2D;0;False;2;FLOAT2;0;FLOAT2;9
...
WireConnection;27;4;59;9
WireConnection;59;10;25;6
ASEEND*/
//CHKSM=C78E89DD4F776E84026E5F5BA2FBC3E509D05BF9