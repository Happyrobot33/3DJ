...
Shader "Control Deck"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_output_6_0_g10 = (i.uv3_texcoord3*_DataInfo.z + _DataInfo.xy);
			float2 break10_g10 = temp_output_6_0_g10;
			...
			o.Emission = ( i.uv3_texcoord3.x >= 0.0 ? ( tex2DNode9 + ( (( break10_g10.y >= 0.0 && break10_g10.y <= 1.0 ) ? (( break10_g10.x >= 0.0 && break10_g10.x <= 1.0 ) ? tex2D( _Udon_3DJ_Data, temp_output_6_0_g10 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) + (( break10_g5.y >= 0.0 && break10_g5.y <= 1.0 ) ? (( break10_g5.x >= 0.0 && break10_g5.x <= 1.0 ) ? tex2D( _Udon_3DJ_Depth, temp_output_6_0_g5 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) + (( break10_g7.y >= 0.0 && break10_g7.y <= 1.0 ) ? (( break10_g7.x >= 0.0 && break10_g7.x <= 1.0 ) ? tex2D( _Udon_3DJ_Color, temp_output_6_0_g7 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) + (( break10_g8.y >= 0.0 && break10_g8.y <= 1.0 ) ? (( break10_g8.x >= 0.0 && break10_g8.x <= 1.0 ) ? tex2D( _Udon_3DJ_Raw_Output, temp_output_6_0_g8 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) + (( break10_g9.y >= 0.0 && break10_g9.y <= 1.0 ) ? (( break10_g9.x >= 0.0 && break10_g9.x <= 1.0 ) ? tex2D( _Udon_3DJ_Raw_Input, temp_output_6_0_g9 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) ) ) : tex2DNode9 ).rgb;
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.SamplerNode;4;-1024,-852;Inherit;True;Property;_MainTex;MainTex;6;0;Create;True;0;0;0;False;0;False;-1;None;e379f79bf757bda4eb4a2ca051a55f15;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-1024,-656;Inherit;True;Property;_Emission;Emission;9;0;Create;True;0;0;0;False;0;False;-1;None;d0e5e6af062a54343a40eaaff0bf61e7;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-1024,-464;Inherit;True;Property;_Metallic;Metallic;7;0;Create;True;0;0;0;False;0;False;-1;None;d0e0f0dc61625dc43af16b69c2f37cb6;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;6;-1024,-272;Inherit;True;Property;_Normal;Normal;8;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;526d49fc30cb23a459dca89710678c4f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;33;-1312,128;Inherit;False;Property;_DataInfo;Data Info;10;0;Create;True;0;0;0;False;0;False;0,0,1;-1.81,-2.51,4;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;27;-992,128;Inherit;False;Map Texture To Area;-1;;10;3d39dafb5f2f01f46b87415ff8f5ece3;0;4;1;SAMPLER2D;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;2;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;2;-2011.94,112.2328;Inherit;False;Global Textures;0;;6;5151b2ab862399e41a33b2b14a355044;0;0;5;SAMPLER2D;0;SAMPLER2D;5;SAMPLER2D;6;SAMPLER2D;7;SAMPLER2D;9
...
ASEEND*/
//CHKSM=11913B0634FA187A4CEBE5E591BE4BEF35962CDB