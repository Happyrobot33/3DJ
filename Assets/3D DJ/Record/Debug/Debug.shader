...
Shader "Debug"
{
	...
	SubShader
	{
		...
		{
			float2 temp_output_18_0 = (float2( 0,0 ) + (i.uv_texcoord - float2( 0,0 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,0.1666667 ) - float2( 0,0 )));
			...
			o.Emission = ( (( i.uv_texcoord.y >= 0.0 && i.uv_texcoord.y <= 0.1666667 ) ? tex2DNode1 :  float4( 0,0,0,0 ) ) + ( (( i.uv_texcoord.y >= 0.1666667 && i.uv_texcoord.y <= 0.3333333 ) ? break6.r :  0.0 ) * color9 ) + ( (( i.uv_texcoord.y >= 0.3333333 && i.uv_texcoord.y <= 0.5 ) ? break6.g :  0.0 ) * color11 ) + ( (( i.uv_texcoord.y >= 0.5 && i.uv_texcoord.y <= 0.6666667 ) ? break6.b :  0.0 ) * color14 ) + (( i.uv_texcoord.y >= 0.6666667 && i.uv_texcoord.y <= 0.8333333 ) ? break6.a :  0.0 ) + (( i.uv_texcoord.y >= 0.8333333 && i.uv_texcoord.y <= 1.0 ) ? tex2D( _Depth, temp_output_18_0 ).r :  0.0 ) ).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.TFHCRemapNode;18;-1369.405,373.1136;Inherit;False;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;1,0.1666667;False;3;FLOAT2;0,0;False;4;FLOAT2;1,1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;2;-2181.523,354.2213;Inherit;True;Property;_ColorAlpha;Color/Alpha;0;0;Create;True;0;0;0;False;0;False;d5eade7947abe2d4ea65c23f9a0c12b3;d5eade7947abe2d4ea65c23f9a0c12b3;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;20;-1094.89,1696.288;Inherit;True;Property;_Depth;Depth;1;0;Create;True;0;0;0;False;0;False;283657a5e09fe4444882d8963bc94119;d5eade7947abe2d4ea65c23f9a0c12b3;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=A089C66C6F0B2141376223FCB30FB8BB965CD1E8